...
import { BarChart3, Bell, BookOpen, ChevronDown, ExternalLink, FolderTree, Image, LayoutDashboard, LogOut, MessageSquareQuote, Package, Plus, RefreshCw, Search, Settings, ShoppingCart, Trash2, Users, Check, X, Save } from 'lucide-react';
